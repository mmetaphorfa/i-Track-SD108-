    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="uac-form" action="{{ route('parent.management.uac', ['id' => $user->id, 'role' => session('role')]) }}" method="post">
                        @csrf
                        @method('patch')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body py-4">
                    <form action="{{ route('parent.management.update', ['id' => $user->id, 'role' => session('role')]) }}" method="post">
                        @csrf
                        @method('put')
