                ...
                <div class="card-body total-sells">
                    <div class="d-flex align-items-center gap-3"> 
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="w-100 mt-1 mb-0">Total Teachers</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body total-sells-4">
                    <div class="d-flex align-items-center gap-3"> 
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="w-100 mt-1 mb-0">Active Teachers</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body total-sells-3">
                    <div class="d-flex align-items-center gap-3"> 
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="w-100 mt-1 mb-0">Inactive Teachers</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        <h4>Teacher List</h4>
                        <a href="{{ route('teacher.management.create', session('role')) }}" class="btn btn-primary btn-sm">Add New</a>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script>
        $(document).ready(function () {
            $("#teacher-table").DataTable({
                ...
                ajax: {
                    url: "{{ route('ajax.getUserData', 'teacher') }}",
                    type: 'get',
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, row) {
                            let url = '{{ route("teacher.management.edit", ["role" => ":role", "id" => ":id"]) }}';
